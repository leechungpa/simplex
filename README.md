...
```bash
# Clone the git and make an environment
git clone https://github.com/leechungpa/simplex
cd simplex

conda create -n simplex python=3.10.0
...
CUDA_VISIBLE_DEVICES=2 python3 main_knn.py \
    ...
    --batch_size 256 \
    --num_workers 1 \
    --pretrained_checkpoint_dir trained_models/simplex/.... \
    --k 1 \
...
# Forked from [solo-learn](https://github.com/vturrisi/solo-learn)
